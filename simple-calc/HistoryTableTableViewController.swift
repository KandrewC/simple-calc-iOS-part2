...
class HistoryTableTableViewController: UITableViewController {
    ...
    private var tasks = HistoryTableTableViewController.getTasks()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.tasks = HistoryTableTableViewController.getTasks()
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            var arr = HistoryTableTableViewController.getTasks()
